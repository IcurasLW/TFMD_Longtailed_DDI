...
if __name__ == "__main__":
    ...
    # Program level args
    parser.add_argument("--data_path", type=str, default="./data/uspto_sep.pickle")
    parser.add_argument("--model_path", type=str,default="models/pre-trained/mask/step=1000000.ckpt")
    parser.add_argument("--dataset", type=str, default="uspto_sep")
    parser.add_argument("--model_type", type=str, default='bart')
    parser.add_argument("--task", type=str, default="forward_prediction")
